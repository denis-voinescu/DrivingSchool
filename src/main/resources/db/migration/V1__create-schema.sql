...
ALTER TABLE instructor ADD FOREIGN KEY (person_id) REFERENCES person (id);
ALTER TABLE enrollment ADD FOREIGN KEY (student_id) REFERENCES student (id);
ALTER TABLE enrollment ADD FOREIGN KEY (instructor_id) REFERENCES instructor (id);
ALTER TABLE enrollment ADD FOREIGN KEY (vehicle_id) REFERENCES vehicle (id);
ALTER TABLE lesson ADD FOREIGN KEY (enrollment_id) REFERENCES enrollment (id);
ALTER TABLE exam ADD FOREIGN KEY (enrollment_id) REFERENCES enrollment (id);
